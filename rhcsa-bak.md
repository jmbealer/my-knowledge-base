...
A Red Hat® Certified System Administrator (RHCSA) is able to perform the
following tasks:
...
- Operate running systems, including booting into different run levels,
  identifying processes, starting and stopping virtual machines, and controlling
  services
...
- Schedule tasks using at and cron and systemd timer units
