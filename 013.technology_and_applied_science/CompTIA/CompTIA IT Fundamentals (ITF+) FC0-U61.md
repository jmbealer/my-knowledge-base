    ...
    - 1.0 IT Concepts and Terminology 17%
        ...
        - 1.2 Compare and contrast fundamental data types and their characteristics.
            ...
            - Strings 
                - What is a string
            - Numbers
                - What are data types dealing with numbers 
                - Integers
                    - What is a integers
                - Floats 
                    - What is a floats
...
- CompTIA IT Fundamentals Acronyms
    - The following is a list of acronyms that appear on the CompTIA IT Fundamentals exam.
    ...
    - CompTIA IT Fundamentals Certification Exam Objectives Version 2.0 (Exam Number: FC0-U61)ACRONYM SPELLED OUT
    - Mb Megabit
    - MB Megabyte
...
- CompTIA IT Fundamentals Proposed Hardware and Software List
    - CompTIA has included this sample list of hardware and software to assist candidates as they prepare for the CompTIA IT Fundamentals exam.
    - This list may also be helpful for training companies that wish to create a lab component for their training offering. 
...
- CompTIA IT Fundamentals (ITF+) is an introduction to basic IT knowledge and skills that helps you determine whether you have what it takes to work in IT. 
- IT Fundamentals (ITF+) covers a range of IT topics and provides a solid grounding in the technology concepts and practices organizations use today.
- Test Details
