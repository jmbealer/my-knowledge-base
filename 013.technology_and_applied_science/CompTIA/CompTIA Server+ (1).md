- **Exam Code SK0-005**
- CompTIA Server+ ensures IT pros have the skills to securely install, deploy, manage and troubleshoot servers.
- ### Exam Details
    - [Size]();-[H3]()
    - **Exam Codes**
        - **SK0-005**
    - **Launch Date**
        - May 18, 2021
    - **Exam Description**
        - CompTIA Server+ validates the hands-on skills of IT professio he nals who install, manage and troubleshoot servers in data centers as well as on-premises and hybrid environments.
    - **Number of Questions**
    ...
    - **Languages**
        - English (at launch), Japanese (at later date)
    - **Retirement**
    ...
    - **Testing Provider**
        ...
        - 
    - **Price**
        - [View price in cart](https://store.comptia.org/auto-add-to-cart?productCode=CompTIASR) ([See all pricing](https://www.comptia.org/testing/exam-vouchers/buy-exam/exam-prices#server))
- About the Exam
