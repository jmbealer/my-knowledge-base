...
| g\_                       | jump to the last non-blank character of the line                                                                |                | vim motions        |
...
|                           | 'very magic' pattern: non-alphanumeric characters are interpreted as special regex symbols (no escaping needed) |                | vim search replace |
...
| S   | delete line and substitute text (same as cc)                          | S   |
