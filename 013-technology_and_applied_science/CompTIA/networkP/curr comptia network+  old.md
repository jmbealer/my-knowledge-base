...
- 1.0 Networking Concepts 23%
    ...
    - 1.8 Summarize evolving use cases for modern network environments.
        ...
        - Secure Access Secure Edge (SASE)/Security Security Edge (SSE)
            - Secure Access Secure Edge (SASE): Converging WAN and security into cloud service.
            - SASE (Secure Access Service Edge): Converging WAN and security into cloud service.
...
- 3.0 Network Operations 19%
    - 3.1 Explain the purpose of organizational processes and procedures.
        ...
        - EOL (End-of-life): Vendor stops selling or marketing a product.
        - EOS (End-of-support): Vendor stops providing updates or technical assistance.
        - IPAM (Internet Protocol Address Management): Software tracking IP address allocation network-wide.
    ...
    - 3.2 Given a scenario, use network monitoring technologies.
        ...
        - MIB: Database of variables managed by SNMP.
        ...
        - SIEM: Real-time analysis of security logs/alerts.
        - Port mirroring: Copying switch traffic to monitor port.
        - Network discovery: Identifying devices present on a network.
        - -- Integrated Acronyms --
        - MIB (Management Information Base): Database of variables managed by SNMP.
        - SIEM (Security Information and Event Management): Real-time analysis of security logs/alerts.
        - SNMP (Simple Network Management Protocol): Protocol monitoring and managing network devices.
    - 3.3 Explain disaster recovery (DR) concepts.
        - -- Glossary --
        - RPO: Max data loss tolerable after disaster.
        - RTO: Max time allowed to restore services.
        - MTTR: Average time to fix a failed device.
        - MTBF: Average time before a component fails.
        ...
        - MTBF (Mean Time Between Failure): Average time before a component fails.
        - MTTR (Mean Time To Repair): Average time to fix a failed device.
        - RPO (Recovery Point Objective): Max data loss tolerable after disaster.
        - RTO (Recovery Time Objective): Max time allowed to restore services.
    - 3.4 Given a scenario, implement IPv4 and IPv6 network services.
        ...
        - SLAAC: IPv6 hosts generating own addresses automatically.
        - DNSSEC: Cryptographic authentication for DNS records.
        - A record: Maps hostname to IPv4 address.
        - AAAA record: Maps hostname to IPv6 address.
        - CNAME record: Alias mapping one hostname to another.
        - MX record: Directs email to domain's mail server.
        ...
        - DHCP (Dynamic Host Configuration Protocol): Automates IP address assignment to network clients.
        - DNS (Domain Name System): Resolves domain names to IP addresses.
        - DNSSEC (Domain Name System Security Extensions): Cryptographic authentication for DNS records.
        - DoH (DNS over HTTPS): Encrypting DNS queries via HTTPS protocol.
        - DoT (DNS over TLS): Encrypting DNS queries via TLS protocol.
        - MX (Mail Exchange): Directs email to domain's mail server.
        - NS (Name Server): Designates authoritative name servers for domain.
        - PTR (Pointer): Maps IP address to hostname (reverse DNS).
        - SLAAC (Stateless Address Autoconfiguration): IPv6 hosts generating own addresses automatically.
        - SOA (Start of Authority): DNS record identifying zone's authoritative source.
        - TXT (Text): DNS record holding arbitrary text information.
...
- 4.0 Network Security 14%
    - 4.1 Explain the importance of basic network security concepts.
        ...
        - IAM: Managing user identities and resource access.
        - MFA: Authentication requiring two or more credential types.
        - SSO: Logging in once to access multiple systems.
        - RADIUS: Server handling authentication for network access.
        - TACACS+: Protocol for AAA services, typically device admin.
        - Least privilege: Granting only minimum necessary access rights.
        - RBAC: Access rights based on user job function.
        ...
        - CIA triad: Security model: Confidentiality, Integrity, Availability.
        - -- Integrated Acronyms --
        - CIA (Confidentiality, Integrity, and Availability): Security model.
        - IAM (Identity and Access Management): Managing user identities and resource access.
        - MFA (Multifactor Authentication): Authentication requiring two or more credential types.
        - PKI (Public Key Infrastructure): Framework managing digital certificates and keys.
        - RADIUS (Remote Authentication Dial-in User Service): Server handling authentication for network access.
        - RBAC (Role-based Access Control): Access rights based on user job function.
        - SAML (Security Assertion Markup Language): XML format exchanging authentication data.
        - SSO (Single Sign-on): Logging in once to access multiple systems.
    ...
    - 4.2 Summarize various types of attacks and their impact to the network.
        ...
        - -- Integrated Acronyms --
        - DDoS (Distributed Denial-of-service): DoS attack from multiple sources simultaneously.
        - DoS (Denial-of-service): Attack preventing legitimate access to resources.
        - ARP (Address Resolution Protocol): Protocol often targeted for poisoning attacks.
        - 
    - 4.3 Given a scenario, apply network security features, defense techniques, and solutions.
        - -- Glossary --
        - Device hardening: Securing a system by reducing attack surface.
        - NAC: Controlling device admission to the network.
        - Port security: Limiting port access by MAC address.
        - 802.1X: Port-based network access control and authentication.
        - ACL: Rules determining access rights to network resources.
        - Screened subnet: Semi-public zone separating internet and LAN.
        - -- Integrated Acronyms --
        - ACL (Access Control List): Rules determining access rights to network resources.
        - NAC (Network Access Control): Controlling device admission to the network.
...
- 5.0 Network Troubleshooting 24%
    - 5.1 Explain the troubleshooting methodology.
        ...
        - Establish a theory: Brainstorm probable causes starting with the obvious.
        - Test the theory: Confirm the cause or escalate if incorrect.
        - Plan of action: Determine steps to fix and assess impact.
        - Implement the solution: Execute the fix or escalate if needed.
        - Verify functionality: Confirm system works and prevent recurrence.
    ...
    - 5.3 Given a scenario, troubleshoot common issues with network services.
        - -- Glossary --
        - Network loop: Traffic circulating endlessly between switches.
