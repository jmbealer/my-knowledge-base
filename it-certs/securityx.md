...
CompTIA SecurityX CAS-005 V5 Certification Exam
...
• Consider cryptographic technologies and techniques, as well as the impact of emerging trends (e.g., artificial
...
enterprise.
EXAM ACCREDITATION
The CompTIA SecurityX exam is accredited by the ANSI National Accreditation Board (ANAB) to show compliance
with the International Organization for Standardization (ISO) 17024 standard and, as such, undergoes regular reviews
...
Minimum of 10 years of general, hands-on IT experience that includes
...
Given a set of organizational security requirements, implement the appropriate governance
components.
...
գ Privacy
գ Operational security
գ Situational awareness
− Communication
− Reporting
...
• Awareness of industryspecific compliance
− Healthcare
− Financial
− Government
− Utilities
...
գ Money
− Capabilities
գ Supply chain access
գ Vulnerability creation
գ Knowledge
գ Exploit creation
• Attack patterns
• Frameworks
...
գ Internally and externally
facing assets
գ Third-party connections
գ Unsanctioned assets/accounts
գ Cloud services discovery
գ Public digital presence
...
գ Selection of appropriate controls
...
Given a scenario, implement security in the early stages of the systems life cycle and
...
− Runtime application selfprotection (RASP)
...
• Detection and threathunting enablers
− Centralized logging
− Continuous monitoring
...
Given a scenario, apply security concepts to the design of access, authentication, and
...
Given a scenario, troubleshoot common issues with identity and access management (IAM)
...
Electronics Engineers (IEEE) 802.1X
− Federation
...
− Post-quantum vs. DiffieHellman and elliptic curve
cryptography (ECC)
− Resistance to quantum
computing decryption attack
...
Given a scenario, analyze vulnerabilities and attacks, and recommend solutions to reduce
the attack surface.
...
− Safe functions
գ Atomic functions
գ Memory-safe functions
գ Thread-safe functions
− Security design patterns
− Updating/patching
գ Operating system (OS)
գ Software
գ Hypervisor
գ Firmware
գ System images
